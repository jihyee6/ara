...
<% String id = (String) session.getAttribute("id"); %>
		<div class='top_header'>
			<div class='header_margin'>
				<div class='logo'>
				  ...
				  <div class="searchBox">
					<a href='../menu/search' class='glasses'><img class='searchImg' src="../image/header/glasses.png"></a>      
			      	<input type="text" class="searchTxt" placeholder="검색"><button class='searchBtn' type='button'>검색</button>
	...
	<!-- 로그인 일관성을 위해 각 페이지에 있던 topSubs 위치 변경 -->
	<div class='topSubs'>
   		<div class='topMenus'>
