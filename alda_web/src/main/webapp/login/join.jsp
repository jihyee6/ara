	...
	<main class='loginContent'>
		...
		<div>
			...
			<form name="form_auth" method="post">
					<input type="submit" value="" class="doBtn" style = 'cursor:pointer; background-image: url("../image/icon/phone.png"); width: 178px; height: 174px; border: none;' onclick="return auth_type_check();">
